...
- **MCP Server for AI Agents:** Run `pkgdiet mcp` to start a Model Context Protocol (MCP) server. Give Antigravity, Claude Code, Cursor, Codex, or GitHub Copilot the ability to natively evaluate dependency health so they stop hallucinating deprecated packages into your codebase.
